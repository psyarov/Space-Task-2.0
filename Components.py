...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def save_key_response(self, key_type, text1, text2, main):
        ...
        if key_type.keys in ['', [], None]:
            key_type.keys = None
        if text1 == 'lang_keys.keys' or text1 == 'proceed_4.keys' or text1 == 'proceed_7.keys' or text1 == 'proceed_5.keys' or text1 == 'proceed_6.keys' or text1 == 'proceed_8.keys' or text1 == 'proceed_9.keys' or text1 == 'proceed_2.keys':
